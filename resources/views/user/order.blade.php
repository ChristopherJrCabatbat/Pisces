            ...
            <form action="{{ route('user.delivery.store') }}" method="POST" class="d-flex w-100">
                ...
                <div class="left d-flex flex-column py-5 pe-5 border-end">
                    ...
                    <div class="form-container">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="note" name="note" style="height: 100px" placeholder="Leave a note here..."></textarea>
                        </div>
                ...
                <div class="right d-flex flex-column py-5 ps-5">
                    ...
                    @php
                        ...
                        $discountAmount = $hasDiscount ? $totalPrice * 0.05 : 0; // Calculate discount
