                    ...
                    @forelse ($completedOrders as $order)
                        ...
                        <div class="timeline">
                            @foreach ($order->items as $item)
                                <!-- Assuming `items` is a relationship for order items -->
                                <!-- Delivered Section -->
                                <div class="timeline-item d-flex align-items-start py-3 top">
                                    <div class="order-width d-flex">
                                        <div class="">
                            ...
                            <div class="timeline-item py-3 d-flex align-items-start">
                                <div class="content order-width d-flex gap-2">
                                    <a href="{{ route('user.buyAgain', $order->id) }}"
                                        class="btn btn-outline-dark w-50">Buy Again</a>
                                    <a href="{{ route('user.viewReview', $order->id) }}"
                                        class="btn btn-outline-dark w-50">View Review</a>
                                </div>
                            </div>
                        </div>
                    @empty
