    ...
    <div class="main-content">
        ...
        <div class="current-file mb-3 d-flex">
            <div class="fw-bold"><i class="fa-solid fa-house me-2"></i><a href="{{ route('admin.dashboard') }}"
                    class="navigation">Dashboard</a> / <a href="/admin/delivery" class="navigation">Delivery</a> /</div>
        ...
        <div class="table-container p-4 text-black mb-4">
            ...
            <form action="{{ route('admin.storeRider') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3 d-flex flex-column justify-content-start align-items-start">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="{{ old('name') }}"
                        required placeholder="e.g. Cardo Dalisay" autofocus>
                </div>
                ...
                <div class="d-grid my-2">
                    <button class="btn btn-primary dark-blue" type="submit">Add Rider</button>
                </div>
            </form>
